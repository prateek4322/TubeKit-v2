          ...
          <div className="group relative">
            ...
            <div className="relative rounded-[1.35rem] border border-white/10 bg-[#070b18]/95 p-2 shadow-2xl shadow-black/50 backdrop-blur-2xl sm:rounded-[1.6rem] sm:p-2.5">
              <div className="flex flex-col gap-2 md:flex-row">
                ...
                <div
                  ref={selectorRef}
                  className="relative w-full md:w-60 lg:w-64"
                >
                  <button
                    type="button"
...
>
  ...
  {!query.trim() && (
    <p className="px-1 text-center text-[10px] font-medium leading-4 text-slate-500 sm:text-xs md:hidden">
      Enter a topic, keyword, URL, or video idea first.
    </p>
  )}
</div>
