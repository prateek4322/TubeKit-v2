...
function Hero({ onToolSelect }) {
  ...
  return (
    <section className="relative overflow-hidden bg-[#050816]">
      <div className="mx-auto flex min-h-[650px] max-w-7xl flex-col items-center justify-center px-6 py-20">
        ...
        <div className="mt-12 w-full max-w-4xl">
          <div className="flex flex-col gap-3 rounded-2xl border border-slate-700 bg-slate-900 p-3 shadow-xl md:flex-row">

            {/* Search Input */}

            <div className="flex h-14 flex-1 items-center rounded-xl border border-slate-700 bg-slate-950 px-4 focus-within:border-blue-500">
...
<div className="relative md:w-64">
  <button
    ...
    className="flex h-14 w-full items-center justify-between rounded-xl
        ...
        >
          {tool.name}
            ...
            <button
              ...
              disabled={!query.trim()}
              className="flex h-14 items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-red-500 via-yellow-400 via-green-500 to-blue-500 px-7 font-semibold text-white transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
            >
