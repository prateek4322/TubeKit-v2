    ...
    <>
      <ToolLayout>
        <ToolHeader
          ...
          description="Generate relevant YouTube hashtags based on your video topic."
        />
        ...
        <section className="mt-12 space-y-10">
          ...
          <div>
            ...
            <p className="mt-3 text-muted-foreground">
              ...
              They help identify the topic or category of content and can
              provide viewers with another way to discover related videos.
            </p>

            <p className="mt-3 text-muted-foreground">
              Hashtags should be relevant to the actual content of your video.
              Using unrelated or misleading hashtags can make your content
              less useful to viewers.
            </p>
          </div>
          ...
          <div>
            <h2 className="text-2xl font-bold">
              Tips for Better YouTube Hashtags
            </h2>

            <ul className="mt-5 list-disc space-y-2 pl-6 text-muted-foreground">
              <li>
                Use hashtags that are directly related to your video.
              </li>
              <li>
                Choose specific hashtags when they accurately describe your
                topic.
              </li>
              <li>
                Avoid adding unrelated hashtags just because they are popular.
              </li>
              <li>
                Keep your hashtags relevant to your target audience.
              </li>
              <li>
                Review every hashtag before adding it to your video.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-6 space-y-6">
              ...
              <div>
                ...
                <p className="mt-2 text-muted-foreground">
                  TubeKit provides the YouTube Hashtag Generator as a free
                  tool for creators.
                </p>
              </div>
            </div>
