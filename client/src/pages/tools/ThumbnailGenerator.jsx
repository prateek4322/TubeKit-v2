...
function ThumbnailGenerator({ query = "" }) {
  ...
  // Hero Search → automatically generate thumbnail ideas
  useEffect(() => {
  ...
  return (
    <>
      <SEO
        ...
        description="Generate creative YouTube thumbnail ideas with TubeKit's free AI Thumbnail Generator. Get visual concepts, text ideas and composition suggestions for your videos."
        keywords="YouTube thumbnail generator, AI thumbnail generator, YouTube thumbnail ideas, thumbnail idea generator, AI YouTube thumbnail ideas, video thumbnail generator, free thumbnail generator"
      ...
      <ToolLayout>
        <ToolHeader
          title="AI YouTube Thumbnail Generator"
          description="Generate creative and engaging YouTube thumbnail concepts with AI in seconds."
        />
        ...
        <section className="mt-12 space-y-10">
          ...
          <div>
            ...
            <p className="mt-3 text-muted-foreground">
              TubeKit's AI YouTube Thumbnail Generator helps creators
              develop thumbnail concepts based on their video topic.
              Enter your topic, generate ideas, review the suggestions,
              and adapt the concept to match your video's content and
              visual style.
            </p>
            ...
            <ol className="mt-5 list-decimal space-y-2 pl-6 text-muted-foreground">
              ...
              <li>
                Choose a concept that represents your video's actual
                content.
              </li>
              <li>
                Use the concept as a guide when creating your final
                thumbnail.
              </li>
            </ol>
          </div>
          ...
          <div>
            ...
            <p className="mt-3 text-muted-foreground">
              A YouTube thumbnail gives viewers a visual preview of a
              video. A useful thumbnail should communicate the subject
              clearly and be easy to understand at a small size.
            </p>
          ...
          <div>
            ...
            <ul className="mt-5 list-disc space-y-2 pl-6 text-muted-foreground">
              <li>
                <strong>Main subject:</strong> Make the primary person,
                object, or idea easy to recognize.
              </li>

              <li>
                <strong>Short text:</strong> Use only the words necessary
          ...
          <div>
            ...
            <ul className="mt-5 grid gap-3 text-muted-foreground sm:grid-cols-2">
              ...
              <li>✓ Regenerate thumbnail ideas</li>
              <li>✓ Free to use</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-5 list-disc space-y-2 pl-6 text-muted-foreground">
              <li>
                Make the subject recognizable at a small size.
              </li>
              ...
              <li>
                Test different concepts to learn what works for your
                audience.
              </li>
            </ul>
          </div>
            ...
            <div className="mt-6 space-y-6">
              <div>
                ...
                <p className="mt-2 text-muted-foreground">
                  It is a tool that generates thumbnail concepts and
                  design ideas based on the topic of a YouTube video.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-muted-foreground">
                  It depends on the tool. A thumbnail idea generator
                  provides concepts and creative direction that can be
                  used to create the final thumbnail.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-muted-foreground">
                  ...
                  useful, a short amount of readable text. Avoid
              ...
              <div>
                ...
                <p className="mt-2 text-muted-foreground">
                  The thumbnail and title should work together and
                  accurately communicate what viewers can expect from
                  the video.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-muted-foreground">
                  TubeKit provides the AI Thumbnail Generator as a free
                  tool for creators.
                </p>
              </div>
            </div>
