    ...
    <>
      <ToolLayout>
        <ToolHeader
          ...
          description="Generate SEO-friendly YouTube descriptions based on your video topic."
        />
            ...
            <div className="mt-6 space-y-6">
              ...
              <div>
                ...
                <p className="mt-2 text-muted-foreground">
                  ...
                  video, but they should be used naturally and should not
                  make the description difficult to read.
                </p>
              </div>
