    ...
    <>
      <ToolLayout>
        <ToolHeader
          ...
          description="Generate engaging YouTube hooks based on your video topic."
        />
        ...
        <section className="mt-12 space-y-10">
          ...
          <div>
            ...
            <p className="mt-3 text-muted-foreground">
              TubeKit's AI YouTube Hook Generator helps creators develop
              opening lines and ideas designed to introduce a video topic
              quickly. Enter your topic, generate hook ideas, and choose or
              adapt the one that best fits your content and audience.
            </p>
          ...
          <div>
            ...
            <p className="mt-3 text-muted-foreground">
              ...
              the topic and gives viewers a reason to continue watching. A
              strong hook can quickly communicate what the video is about and
              establish context for the viewer.
            </p>
          ...
          <div>
            ...
            <ul className="mt-5 list-disc space-y-2 pl-6 text-muted-foreground">
              <li>
                <strong>Question hook:</strong> Start with a question related
                to the viewer's problem or interest.
              </li>

              <li>
                <strong>Problem hook:</strong> Introduce a problem that the
                video will address.
              </li>

              <li>
                <strong>Curiosity hook:</strong> Present an interesting idea
                that encourages viewers to learn more.
              </li>

              <li>
                <strong>Result hook:</strong> Explain what viewers can learn
                or accomplish from the video.
              </li>
          ...
          <div>
            ...
            <ul className="mt-5 list-disc space-y-2 pl-6 text-muted-foreground">
              ...
              <li>
                Use clear language that your audience can understand.
              </li>
              <li>
          ...
          <div>
            ...
            <div className="mt-6 space-y-6">
              ...
              <div>
                ...
                <p className="mt-2 text-muted-foreground">
                  There is no fixed length that works for every video. The
                  hook should communicate the video's main idea quickly
