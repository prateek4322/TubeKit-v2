    ...
    <>
      <ToolLayout>
        <ToolHeader
          ...
          description="Generate engaging YouTube Shorts ideas based on your topic."
        />
        ...
        <section className="mt-12 space-y-10">
          ...
          <div>
            ...
            <p className="mt-3 text-muted-foreground">
              TubeKit's AI YouTube Shorts Generator helps creators develop
              ideas and content concepts for short-form videos. Enter your
              topic, generate suggestions, review them, and customize the
              result for your audience and video style.
            </p>
            ...
            <ol className="mt-5 list-decimal space-y-2 pl-6 text-muted-foreground">
              ...
              <li>
                Edit the result to match your style before recording.
              </li>
            </ol>
          </div>
          ...
          <div>
            ...
            <p className="mt-3 text-muted-foreground">
              ...
              focused information, and an ending that gives the viewer a
              reason to continue engaging with the channel.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-5 list-disc space-y-2 pl-6 text-muted-foreground">
              ...
              <li>
                Deliver the most useful or interesting information.
              </li>
              <li>Keep the content focused on one main topic.</li>
              <li>
                End naturally with a conclusion or relevant call to action.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-5 list-disc space-y-2 pl-6 text-muted-foreground">
              ...
              <li>
                Keep the pacing appropriate for short-form content.
              </li>
              <li>
                Make sure the opening matches the actual content.
              </li>
              <li>
                Avoid misleading claims just to attract attention.
              </li>
            </ul>
          </div>
            ...
            <div className="mt-6 space-y-6">
              <div>
                ...
                <p className="mt-2 text-muted-foreground">
                  It is an AI-powered tool that can generate ideas, concepts,
                  or script suggestions for short-form YouTube videos.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-muted-foreground">
                  Start with a clear opening that quickly establishes the
                  topic or gives viewers a reason to continue watching.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-muted-foreground">
                  ...
                  matches your style, audience, and the information you want
                  to present.
                </p>
              </div>
