...
/>
  ...
  <div>
    <h2 className="text-2xl font-bold">
      How to Use the AI YouTube Script Generator
    </h2>

    <p className="mt-3 text-muted-foreground">
      TubeKit's AI YouTube Script Generator helps creators turn a video
      topic into a structured script. Enter your topic and requirements,
      generate a draft, then review and customize it before recording.
    </p>
  ...
  <div>
    ...
    <p className="mt-3 text-muted-foreground">
      A YouTube script is a written plan for a video. It can organize the
      introduction, main points, examples, transitions, and conclusion
      before recording begins.
    </p>

    <p className="mt-3 text-muted-foreground">
      A structured script can make it easier to stay focused and present
      information clearly. However, the final script should be adapted to
      the creator's natural speaking style.
    </p>
  </div>
  ...
  <div>
    ...
    <ul className="mt-5 list-disc space-y-2 pl-6 text-muted-foreground">
      ...
      <li>Useful examples, details, or supporting information.</li>
  ...
  <div>
    <h2 className="text-2xl font-bold">
      AI YouTube Script Generator Features
    </h2>
    ...
    <div className="mt-6 space-y-6">
      <div>
        ...
        <p className="mt-2 text-muted-foreground">
          It is a tool that creates a draft video script based on a topic
          or instructions provided by the creator.
        </p>
      </div>
      ...
      <div>
        ...
        <p className="mt-2 text-muted-foreground">
          Yes. AI-generated scripts should be reviewed and customized to
          match your voice, audience, and the actual information in your
          video.
        </p>
      </div>
      ...
      <div>
        ...
        <p className="mt-2 text-muted-foreground">
          Yes. Short-form video scripts can also be created by providing
          a focused topic and concise requirements.
        </p>
      </div>
      ...
      <div>
        ...
        <p className="mt-2 text-muted-foreground">
          ...
          Verify factual information and make the script sound natural
          for your audience.
        </p>
      </div>
