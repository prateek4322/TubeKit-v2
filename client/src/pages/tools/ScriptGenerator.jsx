...
function ScriptGenerator({ query = "" }) {
  ...
  // Hero Search → automatically generate script
  useEffect(() => {
  ...
  return (
    <>
      <SEO
        ...
        description="Generate engaging YouTube video scripts with TubeKit's free AI YouTube Script Generator. Create structured scripts for videos and Shorts in seconds."
        keywords="YouTube script generator, AI YouTube script generator, YouTube video script generator, AI script writer, YouTube script writer, free YouTube script generator, Shorts script generator"
        ...
        <section className="mt-12 space-y-10">
          ...
          <div>
            ...
            <ul className="mt-5 list-disc space-y-2 pl-6 text-muted-foreground">
              <li>
                An opening that introduces the video's topic.
              </li>

              <li>
                A clear explanation of the main subject.
              </li>
              ...
              <li>
                Natural transitions between different sections.
              </li>
          ...
          <div>
            ...
            <ul className="mt-5 list-disc space-y-2 pl-6 text-muted-foreground">
              ...
              <li>
                Use examples where they make the topic clearer.
              </li>
              <li>Write in a natural speaking style.</li>
              <li>
                Review AI-generated information before publishing.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-6 space-y-6">
              ...
              <div>
                ...
                <p className="mt-2 text-muted-foreground">
                  Yes. AI-generated scripts should be reviewed and
                  customized to match your voice, audience, and the actual
              ...
              <div>
                <h3 className="text-lg font-semibold">
                  Should I publish an AI-generated script without editing
                  it?
                </h3>

                <p className="mt-2 text-muted-foreground">
                  It is better to review and edit the generated draft
                  first. Verify factual information and make the script
                  sound natural for your audience.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-muted-foreground">
                  TubeKit provides the AI Script Generator as a free tool
                  for creators.
                </p>
              </div>
            </div>
